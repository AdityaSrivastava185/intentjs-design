...
function Features() {
  return (
    <>
      <div className=" sm:py-32 bg-[#000000]">
        <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
          ...
          <div className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
            ...
            {gridItems.map((item, i) => (
              <div key={i}>
                <div className="w-full p-6 rounded-lg shadow dark:bg-zinc-950">
                  <a href="#">
                    <h5 className="mt-2 text-lg font-medium tracking-tight text-green-400 pb-4 max-lg:text-center">
                      {item.title}
                    </h5>
                  </a>
