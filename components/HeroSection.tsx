...
function HeroSection() {
  return (
    <>
      <div className="mx-auto w-full px-6 md:px-10 py-32 sm:py-48 lg:py-20 border-b-2 border-dotted border-zinc-550 mb-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 font-jetmono">
